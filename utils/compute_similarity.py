...
class Compute_Similarity_Python:
    ...
    def applyAdjustedCosine(self):
        ...
        self.dataMatrix = dp.check_matrix(self.dataMatrix, 'csr')
    ...
    def applyPearsonCorrelation(self):
        ...
        self.dataMatrix = dp.check_matrix(self.dataMatrix, 'csc')
...
def similarityMatrixTopK(item_weights, forceSparseOutput=True, k=100, verbose=False, inplace=True):
    ...
    if not sparse_weights:
        ...
        item_weights = dp.check_matrix(item_weights, format='csc', dtype=np.float32)
